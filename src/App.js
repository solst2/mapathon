    ...
    return (
        <div className="App">
          ...
          <header className="App-header">
            ...
            <h2>{user.nickname}</h2>
            <br />
            <App poisList={props.poisList} addPOI={addPOI} deletePOI={deletePOI}  currentUser={user} key="app"></App>
          </header>
  ...
  function BeforLoad(props) {
    return (
        <div className="App">
          ...
          <header className="App-header">
            <h1>Mapathon </h1>
            <h2>Welcom {user.nickname} {user.id_token}</h2>
